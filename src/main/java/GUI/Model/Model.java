...
//        myIndexer.createCorpusDictionary();
       ...
       alertToShow = "There are "+ f.numOfCorpusFiles + " files in the corpus.\n Time: " + (endTime - startTime)/1000000000 + " Seconds to iterate over them all.\n"+ "Dictionary Size:" +myIndexer.corpusSize() ;
